...
<div class="wrap shuriken-analytics shuriken-item-stats shuriken-context-stats">
    ...
    <?php
    $form_id = 'shuriken-ctx-date-filter-form';
    $id_prefix = 'ctx_';
    $hidden_fields_html = '<input type="hidden" name="page" value="shuriken-reviews-context-stats">'
        . '<input type="hidden" name="rating_id" value="' . esc_attr($rating_id) . '">'
        . '<input type="hidden" name="context_id" value="' . esc_attr($context_id) . '">'
        . '<input type="hidden" name="context_type" value="' . esc_attr($context_type) . '">';
    ...
    <div class="shuriken-stats-grid">
        <div class="shuriken-stat-card">
            ...
            <div class="stat-content">
                <h3>
                    <?php echo shuriken_format_rating_value($rating_type, $display_total_votes, $display_total_rating, $average, $analytics, $rating->scale ?: 5); ?>
                </h3>
                <p>
                    <?php
                    if ($rating_type === 'like_dislike') {
