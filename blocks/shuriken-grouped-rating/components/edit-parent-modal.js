...
export default function EditParentModal(ctx) {
    ...
    const {
        setIsEditModalOpen, setNewMirrorName, setEditingMirrorNames, setSavingMirrorId,
        editParentName, setEditParentName, handleEditKeyDown,
        editParentDescription, setEditParentDescription,
        editParentDisplayOnly, setEditParentDisplayOnly,
        editParentType, setEditParentType,
        editParentScale, setEditParentScale,
        selectedRating, updateParentRating, updating,
        parentMirrors, parentMirrorsLoading,
        editingMirrorNames, savingMirrorId,
        updateEditingMirrorName, saveMirrorName, cancelEditMirror,
        startEditMirror, deleteMirror,
        newMirrorName, createMirrorForParent, creatingMirror
    } = ctx;
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(
            ...
            renderRatingTypeScaleFields({
                ...
                typeHelp: selectedRating && parseInt(selectedRating.total_votes, 10) > 0
                    ? __('Rating type cannot be changed after votes are cast.', 'shuriken-reviews')
                    : null,
                scaleHelp: selectedRating && parseInt(selectedRating.total_votes, 10) > 0
