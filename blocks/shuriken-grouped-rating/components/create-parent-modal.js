...
export default function CreateParentModal(ctx) {
    ...
    const {
        ...
        newParentName, setNewParentName, handleCreateKeyDown,
        newParentDescription, setNewParentDescription,
        newParentDisplayOnly, setNewParentDisplayOnly,
        newParentType, setNewParentType,
        newParentScale, setNewParentScale,
        setIsCreateModalOpen, createNewParentRating, creating
    } = ctx;
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(
            ...
            !newRatingIsMirror && renderRatingTypeScaleFields({
                type: newParentType,
